...
-- out_y	=>  Location: PIN_D3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- in_x3	=>  Location: PIN_R1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- in_x2	=>  Location: PIN_L8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- in_x1	=>  Location: PIN_P2,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF CL_Lab1 IS
...
SIGNAL \inst|ALT_INV_inst12~0_combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\inst|ALT_INV_inst12~0_combout\ <= NOT \inst|inst12~0_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \inst|ALT_INV_inst12~0_combout\,
	devoe => ww_devoe,
	o => \out_y~output_o\);
...
-- Equation(s):
-- \inst|inst12~0_combout\ = (\in_x1~input_o\ & (\in_x3~input_o\ $ (!\in_x2~input_o\))) # (!\in_x1~input_o\ & ((\in_x3~input_o\) # (\in_x2~input_o\)))
