...
-- in_y	=>  Location: PIN_P2,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF Lab2_SM_v2 IS
...
-- Equation(s):
-- \inst|LPM_ADD_SUB_component|auto_generated|carry_eqn[0]~0_combout\ = (\in_x~input_o\ & ((\in_z~input_o\) # (\in_y~input_o\))) # (!\in_x~input_o\ & (\in_z~input_o\ & \in_y~input_o\))
...
-- Equation(s):
-- \inst|LPM_ADD_SUB_component|auto_generated|sum_eqn[0]~0_combout\ = \in_x~input_o\ $ (\in_z~input_o\ $ (\in_y~input_o\))
